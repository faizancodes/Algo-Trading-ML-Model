...
def addFeatures():
    ...
    for x in range(len(data)):
        ...
        ema5, ema10, ema15, ema20, ema25, ema30, ema50, ema100, ema200, upperBand, lowerBand, stok, stod, cci, roc, rsiVal])
...
def exportData(dataset, datasetType):
    ...
    if datasetType == 'Features':
        header = 'Date, High, Low, Open, Close, Volume, Adj Close, % Change, MA5, MA10, MA15, MA20, MA25, MA30, MA50, MA100, MA200, EMA5, EMA10, EMA15, EMA20, EMA25, EMA30, EMA50, EMA100, EMA200, Upper Band, Lower Band, Sto %K, Sto %D, CCI, ROC, RSI(14)' + '\n'
...
def checkPerformance(symbol):
    ...
    with open('C:\\Users\\faiza\\OneDrive\\Desktop\\' + symbol + 'PriceLabelsPerformance.csv', 'w') as f:
